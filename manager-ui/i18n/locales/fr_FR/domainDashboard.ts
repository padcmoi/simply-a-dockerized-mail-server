...
export default {
  ...
  spf: {
    ...
    hint: "Enregistrement TXT à publier sur le domaine lui-même. Il autorise {host} ({ips}) à envoyer pour ce domaine. Du SPF publié, seuls les services tiers (include, a, exists) et la terminaison sont repris ; toute autre adresse IP est retirée.",
  ...
  dkim: {
    ...
    recheck: "Revérifier le DNS",
    published: "Publié aujourd'hui :",
    notPublished: "Aucun enregistrement DKIM publié pour ce sélecteur",
