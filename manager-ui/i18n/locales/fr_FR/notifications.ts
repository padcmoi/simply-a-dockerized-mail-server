...
export default {
  ...
  history: {
    ...
    crumb: "Notifications",
    description: "Tout ce qui vous a été signalé, lu et non lu, conservé jusqu'à ce que vous le vidiez.",
    listTitle: "Vos notifications",
    ...
    filterAll: "Toutes",
    filterRead: "Lues seulement",
    filterUnread: "Non lues seulement",
    purgeRead: "Vider les lues",
    purgeAll: "Tout vider",
    purgeReadTitle: "Supprimer toutes les notifications lues ?",
    purgeReadDescription: "Ce que vous n'avez pas ouvert reste. Aucun retour en arrière.",
    purgeAllTitle: "Supprimer tout l'historique des notifications ?",
    purgeAllDescription: "Les non lues comprises, donc une notification jamais ouverte part avec. Aucun retour en arrière.",
    purged: "Historique vidé",
    purgeFailed: "Impossible de vider l'historique",
