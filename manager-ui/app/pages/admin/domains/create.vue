...
setBreadcrumb([{ label: t("nav.domains"), to: "/admin/domains" }, { label: t("domains.form.title") }]);
...
async function create() {
  ...
  try {
    ...
    await navigateTo(`/admin/domains/${created.domain}`);
  } catch (err) {
...
<template>
  <div class="p-4 sm:p-6 xl:p-8 space-y-6 min-w-0">
    ...
    <UButton icon="i-lucide-arrow-left" color="neutral" variant="ghost" to="/admin/domains" size="sm">
