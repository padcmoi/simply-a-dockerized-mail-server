...
- feat(api): add domains/:domainId/spamd/history and stats routes (01-07-2026)
- fix(ui): replace UEmptyState with plain div in DomainDkimSection to fix missing generate button (01-07-2026)
...
- feat(ui): per-domain dashboard with disk quota, mailbox charts, DKIM collapsible, Rspamd and Postfix queue (01-07-2026)
- feat(ui): auto-refresh selector with localStorage persistence, occupancy-rate chart sort (01-07-2026)
- fix(ui): restore Swagger UI proxy routes in nitro routeRules (01-07-2026)
...
- feat(ui): per-domain pages with FQDN routes, domain guard middleware and domain-scoped recipients/aliases/quotas (01-07-2026)
- feat(ui): breadcrumb on all static pages (dashboard, sieve, accounts, profile) (01-07-2026)
...
- fix(dkim): lowercase domain before sidecar call, enforce single key on rotate (01-07-2026)
- feat(ui): DKIM confirm dialogs and collapse-aware generate button (01-07-2026)
- fix(infra): pin rspamd hostname to preserve Redis history keys across restarts (01-07-2026)
- feat(ui): add FR and EN i18n keys for DKIM key generation and rotation dialogs (01-07-2026)
- fix(infra): set static hostname on rspamd container for consistent Redis history key (01-07-2026)
