...
- feat(ui): per-domain dashboard with disk quota, mailbox charts, DKIM, Rspamd and Postfix queue (01-07-2026)
- feat(ui): auto-refresh selector with localStorage persistence, occupancy-rate chart sort and DKIM collapsible (01-07-2026)
