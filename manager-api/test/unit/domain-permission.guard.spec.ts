...
// Same controllable stand-in as test/helpers/e2e.ts makeCpgMock, inline: an
...
describe("DomainPermissionGuard", () => {
  ...
  beforeEach(() => {
    ...
    domains = { findOne: vi.fn().mockResolvedValue({ id: 1, ownerId: "other" }) };
    guard = new DomainPermissionGuard(reflector as never, cpg as never, domains as never);
  });
