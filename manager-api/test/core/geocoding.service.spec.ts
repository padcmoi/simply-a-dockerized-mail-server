...
// A real 200 Response whose body is the given JSON: the service only reads
// `.ok` and `.json()`, and a genuine Response keeps `fetch`'s type intact so the
// resolved value is type-checked instead of cast.
