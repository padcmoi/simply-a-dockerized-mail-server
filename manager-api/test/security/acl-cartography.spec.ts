...
const EXPECTED_PUBLIC = [
  ...
  "GET /api/v1/auth/passport/providers",
  "GET /api/v1/auth/passport/:provider",
  "GET /api/v1/auth/passport/:provider/callback",
  "POST /api/v1/auth/passport/exchange",
  "POST /api/v1/auth/jwt/login",
  "POST /api/v1/auth/jwt/login/two-factor",
  "POST /api/v1/auth/jwt/login/mfa",
  "POST /api/v1/auth/jwt/login/mfa/method",
